...
?>
	...
	<div class="row">
		<div class="col-md-12 pb-3" style="border-bottom: 1px solid rgba(255, 255, 255, 0.5);">
    		...
    		<div class="font-weight-bold toggle_type active" data-kind="<?=$kind?>" data-type="movie" data-target="#watchlist_section" data-user="<?=$user_id?>">
				<span > Movies </span>
				<span class="badge badge-toggle"><?= countItems3 ('type', $kind, 'Movie', 'user_id', $user_id) ?></span>
			</div>
			
			<div class="font-weight-bold toggle_type" data-kind="<?=$kind?>" data-type="tv" data-target="#watchlist_section" data-user="<?=$user_id?>">
				<span >Tv Shows </span>
...
?>
	<div class="mt-4 text-center">
   		 <button id="load_watchlist" class="btn btn-filter cnt loadmore" data-type="movie" data-section="watchlist" data-target="#watchlist_movies" data-btn="#load_watchlist" >Show More</button>
	</div>
