...
?>
	<div class="mt-4 text-center">
   		 <button id="load_favorites" class="btn btn-filter cnt loadmore" data-type="movie" data-section="favorites" data-target="#favorites_movies" data-btn="#load_favorites" >Show More</button>
	</div>
<?
	}
?>
