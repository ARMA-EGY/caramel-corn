			...
			<div class="container-fluid p-3 layer_background">
				<div class="row">
					...
					<?
						...
						{
					?>
						<button class="btn my-3 text-white text-white2 down-btn d-mid-none" data-toggle="modal" data-target="#download_modal"><i class="fas fa-download"></i> Download</button>
