  ...
  <div class="back_layer" >
    ...
    <div class="row pb-4">
        ...
        <div class="section-title ">
			<h4 class="font-weight-bold title_btn text-white">Browse TV Shows</h4>
		...
		<div class="col-md-12">
			...
			<form class="filter_form">
				...
				<div class="col-md-12">
					<h4 class="text-white text-white2 font-weight-bold slide_box pointer mb-0"><i class="fas fa-filter fs-13-t"></i> Filter 
